...
export const mockProducts: DashboardProduct[] = [
  { id: "p1", name: 'MacBook Air 15" M3', slug: "macbook-air-15-m3", category: "Apple Products", brand: "Apple", priceCents: 1899900, stockQuantity: 8, lowStockThreshold: 3, availability: "InStock", condition: "New", isPublished: true, isFeatured: true, createdAt: "2026-05-01", imageUrl: "https://images.unsplash.com/photo-1517336714731-489689fd6ca8?w=200&h=200&fit=crop" },
  { id: "p2", name: "Dell XPS 16", slug: "dell-xps-16", category: "Windows Laptops", brand: "Dell", priceCents: 2599900, stockQuantity: 2, lowStockThreshold: 3, availability: "LowStock", condition: "New", isPublished: true, isFeatured: true, createdAt: "2026-05-02", imageUrl: "https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=200&h=200&fit=crop" },
  { id: "p3", name: "Gaming PC Ryzen 7", slug: "gaming-pc-ryzen-7-rtx-4070", category: "Gaming PCs", brand: "Custom Build", priceCents: 2199900, stockQuantity: 5, lowStockThreshold: 3, availability: "InStock", condition: "New", isPublished: true, isFeatured: true, createdAt: "2026-05-03", imageUrl: "https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=200&h=200&fit=crop" },
  { id: "p4", name: "iPad Pro 13″ M4", slug: "ipad-pro-13-m4", category: "Apple Products", brand: "Apple", priceCents: 1649900, stockQuantity: 0, lowStockThreshold: 3, availability: "OutOfStock", condition: "New", isPublished: true, isFeatured: true, createdAt: "2026-05-04", imageUrl: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=200&h=200&fit=crop" },
  ...
  { id: "p9", name: 'MacBook Pro 14" M4', slug: "macbook-pro-14-m4-pro", category: "Apple Products", brand: "Apple", priceCents: 2799900, stockQuantity: 3, lowStockThreshold: 3, availability: "InStock", condition: "New", isPublished: true, isFeatured: false, createdAt: "2026-05-09", imageUrl: "https://images.unsplash.com/photo-1517336714731-489689fd6ca8?w=200&h=200&fit=crop" },
  { id: "p10", name: "ASUS ROG Strix G16", slug: "asus-rog-strix-g16", category: "Gaming PCs", brand: "ASUS", priceCents: 2249900, stockQuantity: 1, lowStockThreshold: 3, availability: "LowStock", condition: "New", isPublished: true, isFeatured: false, createdAt: "2026-05-10", imageUrl: "https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=200&h=200&fit=crop" },
];
...
export const mockCategories: DashboardCategory[] = [
  { id: "cat1", name: "Apple Products", slug: "apple", description: "MacBooks, iPads, iPhones", productCount: 12, isActive: true, sortOrder: 1 },
  { id: "cat2", name: "Windows Laptops", slug: "windows", description: "Dell, HP, Lenovo", productCount: 15, isActive: true, sortOrder: 2 },
  { id: "cat3", name: "Gaming PCs", slug: "gaming", description: "Gaming desktops and laptops", productCount: 8, isActive: true, sortOrder: 3 },
