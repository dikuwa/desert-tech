    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background lg:hidden">
      <div className="flex items-center gap-2 px-4 py-2">
        <a
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-md bg-whatsapp px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-whatsapp-hover"
        >
