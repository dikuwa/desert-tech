...
export function DocumentPublicView({
  ...
  const handleWhatsApp = () => {
    const msg = encodeURIComponent(
      `Here is your ${typeLabel.toLowerCase()} ${documentNumber} from Desert Technology.\n\nView online: ${shareUrl}`,
    );
      ...
      <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
        ...
        <div className="flex items-center justify-center gap-2 text-[10px] text-muted-foreground">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-whatsapp/20 px-3 py-1.5 text-xs font-medium text-whatsapp hover:bg-whatsapp hover:text-white transition-colors"
          >
