...
//
// TEMPORARY: force mock auth for debugging — the real handler is having issues
const useMockAuth = !process.env.DATABASE_URL || process.env.NODE_ENV !== "production" || true;
